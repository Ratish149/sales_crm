...
from .views import OrderListCreateAPIView, OrderRetrieveUpdateDestroyAPIView, DashboardStatsView, MyOrderListAPIView, MyOrderStatusView
...
urlpatterns = [
    ...
    path('my-order-status/', MyOrderStatusView.as_view(),
