...
from .views import (
    BannerImageListCreateView,
    BannerImageRetrieveUpdateDestroyView,
    BannerListCreateView,
    BannerRetrieveUpdateDestroyView,
    PopUpCreateView,
    PopUpFormCreateView,
    PopUpFormRetrieveUpdateDestroyView,
    PopUpRetrieveUpdateDestroyView,
)
...
urlpatterns = [
    ...
    path(
        "popup/<int:pk>/",
        PopUpRetrieveUpdateDestroyView.as_view(),
        name="popup-retrieve-update-destroy",
    ),
    path("popup-form/", PopUpFormCreateView.as_view(), name="popup-form-create"),
    path(
        "popup-form/<int:pk>/",
        PopUpFormRetrieveUpdateDestroyView.as_view(),
        name="popup-form-retrieve-update-destroy",
    ),
    path(
        "banner-images/",
        BannerImageListCreateView.as_view(),
        name="banner-image-list-create",
    ),
    path(
        "banner-images/<int:pk>/",
        BannerImageRetrieveUpdateDestroyView.as_view(),
